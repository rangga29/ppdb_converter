...
class Tbtk extends CI_Controller
{
	...
	public function pdf_pendaftaran($slug_nama_lengkap)
	{
		...
		<table border="0" cellspacing="3" cellpadding="4">
			...
			<tr>
				...
				<td colspan="2">: ';
				$pdf->Image($bukti_pembayaran, 80, 150, 80, '', '' , '', '', 'true', 300, '', false, false, 1, false, false, false);
		$html .='
				</td>
			</tr>
		</table>';
	...
	public function pdf_dapodik($slug_nama_lengkap)
	{
		...
		$pdf->Image($pas_foto, 20, 60, 80, '', '' , '', '', 'true', 300, '', false, false, 1, false, false, false);
		$html .='</table>';
		$pdf->lastPage();
		$pdf->writeHTML($html, true, false, true, false, '');
		...
		$pdf->StartTransform();
		$pdf->Rotate(90);
		$pdf->Image($scan_kk, -240, 35, 235, '', '' , '', '', 'true', 300, '', false, false, 1, false, false, false);
		$pdf->StopTransform();
		$pdf->lastPage();
		...
		$pdf->StartTransform();
		$pdf->Rotate(90);
		$pdf->Image($scan_ak, -240, 35, 235, '', '' , '', '', 'true', 300, '', false, false, 1, false, false, false);
		$pdf->StopTransform();
		$pdf->lastPage();
